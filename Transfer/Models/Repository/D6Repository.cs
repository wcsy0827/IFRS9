...
AND Version = @Version ; ";
        ...
        public List<D6CheckViewModel> getD6Check(string reportDate)
        {
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                ...
                #region 是否完成風控覆核
                sb = new StringBuilder();
                _Job_Details = Impairment_Operations_Type.RiskReview.GetDescription();
                if (_UuDoneFlag)
                {
...
FROM TEMP ";
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public List<VersionInfo> getD6Version(DateTime dt)
        {
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                result = db.Version_Info
                    ...
                    .Select(x => new VersionInfo
                    {
                        ...
                        VersionContent = x.Version_Content
                    })
                    .Distinct()
                    .OrderBy(x => x)
                    .ToList();
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                result = db.Bond_Quantitative_Resource
                    ...
                    .Select(x => new StatusInfo
                    {
                        ...
                        Description = x.StatusInfo.Description
                    })
                    .Distinct()
                    .OrderBy(x => x)
                    .ToList();
