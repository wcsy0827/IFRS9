...
namespace Transfer.Report.Data
{
    public class D63 : ReportData
    {
        public override DataSet GetData(List<reportParm> parms)
        {
            ...
            List<D63ViewModel> queryData = d6Repository.getD63(reportDate, "", Evaluation_Status_Type.All, "All", false, ReferenceNbr);
            DataTable dt = queryData.ToDataTable();
