...
INSERT INTO [SMF_Group]
     ...
     VALUES
        ...
        /// <returns></returns>
        public Tuple<int, List<SummaryReportInfo>> GetSummaryBasicTest(DateTime reportDate, string isPass)
        {
            int count = 0;
            ...
            return new Tuple<int, List<SummaryReportInfo>>(count, result);
        }
        ...
        /// <param name="isPass"></param>
        /// <returns></returns>
        public Tuple<int, List<SummaryReportInfo>> GetSummaryWatchIND(DateTime reportDate, string isPass)
        {
            int count = 0;
            List<SummaryReportInfo> result = new List<SummaryReportInfo>();
        ...
        /// <param name="isPass"></param>
        /// <returns></returns>
        public Tuple<int, List<SummaryReportInfo>> GetSummaryWarningIND(DateTime reportDate, string isPass)
        {
            int count = 0;
            List<SummaryReportInfo> result = new List<SummaryReportInfo>();
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public List<SelectOption> GetD75Version(DateTime data)
        {
        ...
        /// <param name="version"></param>
        /// <returns></returns>
        public List<SelectOption> GetD75Status(DateTime reportDate, int version)
        {
            List<SelectOption> result = new List<SelectOption>();
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                result = db.Bond_Quantitative_Resource
                    ...
                    .Join(db.Status_Info
                    .AsNoTracking()
                    , BondQuantitativeResource => BondQuantitativeResource.Risk_Control_Status
                    , StatusInfo => StatusInfo.Status
                    , (BondQuantitativeResource, StatusInfo) => new { BondQuantitativeResource, StatusInfo })
                    .Where(
                    x => x.BondQuantitativeResource.Report_Date == reportDate &&
                    x.BondQuantitativeResource.Version == version &&
                    x.BondQuantitativeResource.Send_to_Auditor == "Y" &&
                    x.BondQuantitativeResource.Result_Version_Confirm != null &&
                    x.BondQuantitativeResource.Quantitative_Pass_Confirm == "Y")
                    .Select(x => new SelectOption
                    {
        ...
        public MSGReturnModel SubmitD75Review(Dictionary<string, string> data)
        {
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                ...
                Bond_Quantitative_Resource BondQuantitativeResource = db.Bond_Quantitative_Resource.FirstOrDefault(
                    x => x.Report_Date == reportDate &&
                    x.Version == version &&
                    x.Send_to_Auditor == "Y" &&
                    x.Result_Version_Confirm != null &&
                ...
                {
                    BondQuantitativeResource.Risk_Control_Status = 1;
                }
                ...
                if (BondRiskControlResult == null)
                {
                    db.Bond_Risk_Control_Result.Add(new Bond_Risk_Control_Result()
                    {
                        ...
                        D63_D64_Handle_Opinion = data["D63_D64_Handle_Opinion"],
                ...
                {
                    BondRiskControlResult.Status = 1;
                    ...
                    BondRiskControlResult.Second_Order = data["Second_Order"];
                    ...
                    BondRiskControlResult.D63_D64_Handle_Opinion = data["D63_D64_Handle_Opinion"];
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                result = db.Bond_Risk_Control_Result
                    ...
                    .Select(x => new D75ViewModel
                    {
                        ...
                        D63_D64_Handle_Opinion = x.D63_D64_Handle_Opinion,
                        ...
                        D63_D64_First_Order_Opinion = x.D63_D64_First_Order_Opinion,
                        ...
                        D63_D64_Second_Order_Opinion = x.D63_D64_Second_Order_Opinion,
        ...
        public MSGReturnModel CloseD75Review(Dictionary<string, string> data)
        {
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                ...
                {
                    BondQuantitativeResource.Risk_Control_Status = 0;
                }
                ...
                {
                    D6Repository.DelQuantifyAndQualitativeFile("D75", file.Check_Reference, file.File_Name);
                }
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                ...
                else
                {
                        ...
                        BondRiskControlResult.First_Order_Status == 1)
                    {
                        ...
                        BondRiskControlResult.D63_D64_First_Order_Opinion = data["D63_D64_First_Order_Opinion"];
                        ...
                        BondRiskControlResult.Second_Order_Status == 1)
                    {
                        ...
                        BondRiskControlResult.D63_D64_Second_Order_Opinion = data["D63_D64_Second_Order_Opinion"];
                    ...
                    {
                        BondRiskControlResult.Status = 2;
                        BondQuantitativeResource.Risk_Control_Status = 2;
                    }
                }
        ...
        public MSGReturnModel ReturnD75Review(Dictionary<string, string> data)
        {
            ...
            using (IFRS9DBEntities db = new IFRS9DBEntities())
            {
                ...
                else
                {
                    ...
                    BondQuantitativeResource.Risk_Control_Status = 3;
                }
