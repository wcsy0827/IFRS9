...
public partial class IFRS9Entities : DbContext
{
    ...
    public virtual DbSet<Econ_D_Var_Lag_C13_2018> Econ_D_Var_Lag_C13_2018 { get; set; }

    public virtual DbSet<Econ_D_Var_Lag_C13_2019> Econ_D_Var_Lag_C13_2019 { get; set; }

    public virtual DbSet<Econ_Foreign> Econ_Foreign { get; set; }

    public virtual DbSet<GM_YYYY> GM_YYYY { get; set; }

    public virtual DbSet<IFRS9_Bond_Report> IFRS9_Bond_Report { get; set; }

    public virtual DbSet<IFRS9_CPD> IFRS9_CPD { get; set; }

    public virtual DbSet<IFRS9_Impaire_Override> IFRS9_Impaire_Override { get; set; }

    public virtual DbSet<IFRS9_Payment_Schedule> IFRS9_Payment_Schedule { get; set; }
    ...
    public virtual DbSet<Moody_Recovery_Info> Moody_Recovery_Info { get; set; }

    public virtual DbSet<Moody_Recovery_Info_Position> Moody_Recovery_Info_Position { get; set; }
    ...
    public virtual DbSet<temp_Loan_default_Info> temp_Loan_default_Info { get; set; }

    public virtual DbSet<Tm_Adjust_YYYY> Tm_Adjust_YYYY { get; set; }

    public virtual DbSet<toIT> toITs { get; set; }

    public virtual DbSet<IFRS9_Transition_Matrix> IFRS9_Transition_Matrix { get; set; }
    ...
    public virtual DbSet<temp_Rating_History> temp_Rating_History { get; set; }
